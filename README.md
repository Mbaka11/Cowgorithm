...
| 04  | [Pet Segment](docs/market-study/04-segment-pets.md)                                | Dogs & cats — GPS trackers, differentiation, consumer market  | **Draft**   |
| 05  | [Sport & Performance Segment](docs/market-study/05-segment-sport-performance.md)   | Human athletes (soccer, hockey), equestrian, working dogs     | **Draft**   |
| 06  | [Competitive Landscape](docs/market-study/06-competitive-landscape.md)             | Competitor matrix, white-space analysis, IP landscape         | **Draft**   |
| 07  | [Market Study Summary](docs/market-study/07-market-study-summary.md)               | Segment ranking, primary recommendation, derivative roadmap   | **Draft**   |
...
| **2. Market Study**          | Quebec-focused research across 4 segments | Phase 1    | **Complete** (7/7 docs drafted)    |
